...
export default function SignInPage() {
  ...
  const [email, setEmail] = useState('merchant@lunchbox.test');
  ...
  return (
    <AppShell brand={<Link href="/">🧑‍🍳 Lunchbox Merchant</Link>}>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="rounded-md bg-stone-50 p-2 text-xs text-stone-500">
                Demo: <code>merchant@lunchbox.test</code> / <code>lunchbox</code>
              </p>
            </form>
          </CardContent>
        </Card>
