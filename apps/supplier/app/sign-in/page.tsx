...
export default function SignInPage() {
  ...
  const [email, setEmail] = useState('supplier@lunchbox.test');
  ...
  return (
    <AppShell brand={<Link href="/">🥬 Lunchbox Supplier</Link>}>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="rounded-md bg-stone-50 p-2 text-xs text-stone-500">
                Demo: <code>supplier@lunchbox.test</code> / <code>lunchbox</code>
              </p>
            </form>
          </CardContent>
        </Card>
